        ...
        <header className='flex flex-col gap-5 md:gap-8'>
            <Link href="/" className="cursor-pointer flex items-center gap-1">
                <Image
                    ...
                    alt="PrimeVault Logo"
                />
                <h1 className="text-26 font-ibm-plex-serif font-bold text-black-1">PrimeVault</h1>
            </Link>

            <div className="flex flex-col gap-1 md:gap-3">
                <h1 className="text-24 lg:text-36 font-semibold text-gray-900s">
                    {user
                    ?'Link Account'
                    :type === 'sign-in'
                    ?'Sign In'
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                        {type === 'sign-up' && (
                            <>
                                ...
                                <CustomInput 
                                    control={form.control} name='address1' label="Address1" placeholder='Enter your specific address'
                                />
                                <CustomInput 
                                ...
                                <div className="flex gap-4">
                                    ...
                                    />
                                    <CustomInput 
                                        control={form.control} name='postalCode' label="Postal Code" placeholder='Example: 1101'
                                    />
                                </div>
                                <div className="flex gap-4">
                                    <CustomInput 
